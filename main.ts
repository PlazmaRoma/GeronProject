...
//     {name: "Fill", age: 32, gender: "Male", job: "Google", education: true, lead: "SEO"},
//     {name: "Erling", age: 44, gender: "Male", job: "Microsoft", education: true, lead: "Manager"},
//     {name: "Alina", age: 19, gender: "Female", job: "BBC", education: false, lead: "Journalist"}
// ]

// const filteredStHum = stateHumanes.filter(
//     (statehum) => statehum.education === true && (statehum.lead === "SEO" || statehum.lead === "Manager")
// )
